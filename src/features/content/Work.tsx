   ...
   return (
      <div className="mt-24" id="work">
         ...
         <div>
            ...
            aliquet pulvinar nullam amet scelerisque sodales at justo. Condimentum maecenas vel mus felis elementum est
            phasellus. Fermentum euismod metus venenatis pharetra convallis. Nostra nascetur bibendum donec duis cras
            magna mattis.
         </div>{' '}
         <div>
            Lorem ipsum odor amet, consectetuer adipiscing elit. Quisque orci proin faucibus lacinia fermentum sapien;
